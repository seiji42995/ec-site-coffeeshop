...
public class Order {
	...
	public Order(Integer id, Integer userId, Integer status, Integer totalPrice, Date orderDate, String destinationName,
			...
			Timestamp deliveryTime, Integer paymentMethod, List<OrderItem> orderItemList) {
		super();
		this.id = id;
		this.userId = userId;
		this.status = status;
	 ...
	 */
	public int getTax() {
		int sumOrderItemPrice = 0;
		for(OrderItem orderItem : this.orderItemList) {
			sumOrderItemPrice += orderItem.getSubTotal();
		}
		int tax = sumOrderItemPrice / 10;
		return tax;
	}
